...
public class PreguntasDAOTest {
    ...
    public void addPreguntaTest() {
        ...
        preguntasDAO.addPregunta("texto", "respuestasCorrectasTexto", "respuestasCorrectas","00", null);
        verify(preguntasDAO).addPregunta("texto", "respuestasCorrectasTexto", "respuestasCorrectas","00", null);
